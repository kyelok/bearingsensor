/****************************************************************************/
/*   bearingwear.cmd - Linker command file for F2811 device              	*/
/*	 Note there is no external bus, therefore no external ram on the F2811	*/
/*                                                                          */
/*   Description: This file is a F2811 linker command file that can 		*/
...
MEMORY
{
   ...
   PAGE 0 : FLASHMEM      : origin = 0x3D8000, length = 0x1FF00      /*on-chip FLASH for the TMS320f2811*/
...
SECTIONS
{
   ...
   /* allocate a section relating to ADC variables etc */
   .adcsection1 : > M1RAM, PAGE = 1
   ...
   .boot > BOOT, PAGE 0
   {
		-lrts2800_ml.lib <boot28.asm.obj> (.text)
   }
