...
//
// Added ability to handle multiple files
...
namespace AssemblyInfoUtil
{
    ...
    class AssemblyInfoUtil
    {
        ...
        private static string ProcessLine(string line, bool isVB)
        {
            if (isVB)
            {
        ...
        private static string ProcessLinePart(string line, string part)
        {
            ...
            // If we have a comment before then ignore
