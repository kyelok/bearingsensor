...
<h2>Reset 6Hr Pre-warning</h2>
    <p>Are you sure you wish to reset 6Hr pre-warning?</p>
    <ul class="button">
        <li class="button"><%= Html.ActionLink("Yes", "ResetPrewarningComplete")%></li>
