...
namespace ModbusRegistersUnitTests
{
    ...
    /// <summary>
    ///This is a test class for CylinderDeviationRegisterTest and is intended
    ///to contain all CylinderDeviationRegisterTest Unit Tests
    ///</summary>
    [TestClass()]
    public class CylinderDeviationRegisterTest
    {
        ...
        /// <summary>
        ///A test for CylinderDeviationRegister Constructor
        ///</summary>
        [TestMethod()]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void CylinderDeviationRegisterConstructorTest()
        {
            byte id = 1;
            ushort address = 1;
            byte externalId = 1;
        ...
        public void CalculateValueTest_alarm()
        {
            ...
            CylinderDeviationRegister target = new CylinderDeviationRegister(id, address, externalId, externalAddress);
            ...
            spuRegisters[298].Value = unchecked((ushort)1);
            ushort expected = 2;
            ushort actual;
        ...
        public void CalculateValueTest_Disabled()
        {
            ...
            //Populate the specfic registers with sensor readings
            spuRegisters[270].Value = unchecked((ushort)-32761); 
            ushort expected = 8;
            ushort actual;
            actual = target.CalculateValue(spuRegisters);
        ...
        public void CalculateValueTest_SensorAdjustment()
        {
            ...
            //Populate the specfic registers with sensor readings
            spuRegisters[270].Value = unchecked((ushort)-32762);
            ushort expected = 16;
            ushort actual;
            actual = target.CalculateValue(spuRegisters);
        ...
        public void CalculateValueTest_SensorFailure()
        {
            ...
            //Populate the specfic registers with sensor readings
            spuRegisters[270].Value = unchecked((ushort)-32766);
            ushort expected = 64;
            ushort actual;
            actual = target.CalculateValue(spuRegisters);
        ...
        public void CalculateValueTest_SensorFailure_LowLevel()
        {
            ...
            //Populate the specfic registers with sensor readings
            spuRegisters[270].Value = unchecked((ushort)-32765);
            ushort expected = 256;
            ushort actual;
            actual = target.CalculateValue(spuRegisters);
        ...
        public void CalculateValueTest_SensorFailure_HighLevel()
        {
            ...
            //Populate the specfic registers with sensor readings
            spuRegisters[270].Value = unchecked((ushort)-32764); 
            ushort expected = 512;
            ushort actual;
            actual = target.CalculateValue(spuRegisters);
        ...
        public void CalculateValueTest_SensorFailure_RpmOOR()
        {
            ...
            //Populate the specfic registers with sensor readings
            spuRegisters[270].Value = unchecked((ushort)-32763); 
