...
namespace ModbusServer
{
    ...
    class InternalTempTCPServer : IServerInterface
    {

        private static readonly log4net.ILog logger = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        const byte SlaveId = 1;
        const int ModbusPort = 2502;
        ...
        public InternalTempTCPServer(AMOTProxyDataStore dataStore)
        {
        ...
        public void Start()
        {
            ...
            slave.Listen();
            logger.WarnFormat("Started Modbus slave for {0} on Port {1}", address, ModbusPort);
