...
{
    class RegistersInt32 : Registers
    {
        public RegistersInt32(ushort startReg, ushort endReg, String description, String[] fields, String table)
            : base(startReg, endReg, description, fields, table)
        {
            intSize = 2;
        }

        public RegistersInt32(ushort startReg, String description, String field, String table)
