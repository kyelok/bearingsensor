...
namespace IISStarter
{
    class IISExpress
    {
        ...
        IISExpress(string config, string site, string apppool, bool hide)
        {
            Config = config;
            Site = site;
            AppPool = apppool;
        ...
        public static IISExpress Start(string config, string site, string apppool, bool hide)
        {
            return new IISExpress(config, site, apppool, hide);
        }
