 ...
 * MapColor
 * 
 * Maps from a color string to a Color
 * 
 * Copyright (C) MPC Data Limited 2012. All rights reserved.
 * 
 * Originator: GSmith, 28/05/2012
 */
...
namespace XTS
{
    ...
    public static class ColorFromString
    {
        ...
        /// <summary>
        /// This method maps a string that defines a color to a Color
        /// object.  If the string passed in does not match then Red is returned
        /// by default.
        /// </summary>
        /// <param name="value">The string that defines a color</param>
        /// <returns>The Color object that maps to the string passed in.</returns>
