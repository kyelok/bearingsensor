 ...
 * C# partial implementation of BarControl.xaml silverlight user control.
 * 
...
namespace XTS.Controls
{
	...
	public partial class BarControl : UserControl
    {
        ...
        /// </summary>
        public enum BarControlDirection
        {
            Up,
            Down
        }
        ...
        /// </summary>
        private BarControlDirection direction = BarControlDirection.Down;
        /// <summary>
        /// Sets wether the top of the bar chart is the MaxValue or MinValue
        /// </summary>
        public BarControlDirection Direction
        {
            set
            {
        ...
        public static readonly DependencyProperty StatusProperty = DependencyProperty.Register(
            "Status", typeof(XTSSensorStatus), typeof(BarControl), new PropertyMetadata(XTSSensorStatus.Normal, OnStatusPropertyChanged));
        ...
        {
            BarControl barControl = dependencyObject as BarControl;
            barControl.SetStatus((XTSSensorStatus)e.NewValue);
        }
        ...
        public static readonly DependencyProperty ValueProperty = DependencyProperty.Register(
            "Value", typeof(int), typeof(BarControl), new PropertyMetadata(0, OnValuePropertyChanged));
        ...
        {
            BarControl barControl = dependencyObject as BarControl;
            barControl.SetValue((int)e.NewValue);
        }
        ...
        private void RenderGraph()
        {
            ...
            else
            {
                if (this.showAlarm)
                {
                    alarmNeg.Visibility = System.Windows.Visibility.Visible;
                }
                else
                {
                    alarmNeg.Visibility = System.Windows.Visibility.Collapsed;
                ...
                {
                    sdownNeg.Visibility = System.Windows.Visibility.Visible;
                }
                else
                {
                    sdownNeg.Visibility = System.Windows.Visibility.Collapsed;
            ...
            this.bar_graph.VerticalAlignment = System.Windows.VerticalAlignment.Center;
            double fullHeight = this.GridChart.ActualHeight-6; // Subtract 3 pixels each for border top/bottom
            double pixelsPerUnit = fullHeight / (this.maxValue - this.minValue);

            this.PathAlarm0.Margin = new Thickness(0, ((this.alarm * pixelsPerUnit) * 2) - 1, 0, 0);
            this.PathAlarm1.Margin = new Thickness(0, 0, 0, ((this.alarm * pixelsPerUnit) * 2) - 1);
            this.PathSlowdown0.Margin = new Thickness(0, ((this.slowdown * pixelsPerUnit) * 2) - 1, 0, 0);
            this.PathSlowdown1.Margin = new Thickness(0, 0, 0, ((this.slowdown * pixelsPerUnit) * 2) - 1);
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (this.direction == BarControlDirection.Up)
                    {
                        offset *= -1;
                    }
				...
				this.PathZeroPoint.Margin = new Thickness(0, zeroPoint*2, 0, 0);
            }
            this.PathZeroPoint.Visibility = chartExtrasVisible;
