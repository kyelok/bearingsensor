...
namespace ModbusDb
{
    public class RegistersDateTime : Registers
    {
        private int logSchedule;

        public RegistersDateTime(ushort startReg, ushort endReg, String description, int logSchedule)
