...
namespace ModbusDb
{
    public class RegistersUInt32 : Registers
    {
        public RegistersUInt32(ushort startReg, ushort endReg, String description, String[] fields, String table, String[] channelname)
            : base(startReg, endReg, description, fields, table, channelname)
        {
            intSize = 2;
        }

        public RegistersUInt32(ushort startReg, String description, String field, String table, String channelname)
