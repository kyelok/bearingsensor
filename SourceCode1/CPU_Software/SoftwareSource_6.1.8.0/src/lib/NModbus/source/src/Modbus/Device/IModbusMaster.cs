...
namespace Modbus.Device
{
	...
	public interface IModbusMaster : IDisposable
	{
        ...
        /// <returns>Holding registers status</returns>
        /// 
        ushort[] ReadHoldingRegistersTemp(byte slaveAddress, ushort startAddress, ushort numberOfPoints);
		/// <summary>
        ...
        RegisterCollection DiagnosticRequest(byte slaveAddress, ushort subfunctionCode, ushort[] data);
	}
}
