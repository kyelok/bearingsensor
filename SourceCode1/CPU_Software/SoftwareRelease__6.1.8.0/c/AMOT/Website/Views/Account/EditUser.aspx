...
<% using(Html.BeginForm("EditUserComplete", "Account")) { %>
<table>
    <tr>
    ...
    <tr>
        <td>New Password</td><td><%= Html.PasswordFor(m => m.NewPassword, new { Onfocus = "TextInputFocus('NewPassword', false)" })%> <%= Html.ValidationMessageFor(m => m.NewPassword) %></td>
    </tr>
    <tr>
        <td>Re-enter New Password</td><td><%= Html.PasswordFor(m => m.NewPasswordCheck, new { Onfocus = "TextInputFocus('NewPasswordCheck', false)" })%> <%= Html.ValidationMessageFor(m => m.NewPasswordCheck) %></td>
    </tr>
