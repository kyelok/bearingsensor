...
<h2>Reset Learning Values</h2>
    <p>Are you sure you wish to reset learning values?</p>
    <ul class="button">
        <li class="button"><%= Html.ActionLink("Yes", "ResetLearningValuesComplete") %></li>
