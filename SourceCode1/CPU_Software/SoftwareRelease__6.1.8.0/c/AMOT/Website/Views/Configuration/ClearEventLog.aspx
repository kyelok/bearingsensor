<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<ConfigurationWebsite.Models.ClearEventLogModel>" %>
...
<%if (Model.CanClear)
  { %>
  <p>Click below to clear the event log. Note: You cannot undo this action.</p>
  <ul class="button">
    <li class="button"><%= Html.ActionLink("Clear", "ClearEventLogComplete")%></li>
  </ul>
  <% }
  else
  {
  %>
      <ul class="button"><li class="disabledButton"><a>Clear</a></li></ul>
  <% } %>
