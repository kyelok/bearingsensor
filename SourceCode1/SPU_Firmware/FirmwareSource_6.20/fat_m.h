...
extern int fm_initvolume(int drvnumber,F_INITFUNC pfunc,void *user_ptr);
...
extern int fm_flush(F_FILE *filehandle);
extern F_FILE *fm_open(const char *filename,const char *mode);
extern F_FILE *fm_truncate(const char *filename,unsigned long length);
...
extern int fm_seteof(F_FILE *filehandle);
...
extern int fm_wfindfirst(const wchar *filename,F_WFIND *find);
extern int fm_wfindnext(F_WFIND *find);
extern int fm_wrename(const wchar *filename, const wchar *newname);
extern long fm_wfilelength(const wchar *filename);
extern F_FILE *fm_wopen(const wchar *filename,const wchar *mode);
extern F_FILE *fm_wtruncate(const wchar *filename,unsigned long length);
