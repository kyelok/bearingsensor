/****************************************************************************/
/*   bearingwear.cmd - Linker command file for F28xx devices            	*/
...
/*   NOTE MUST USE SDFLASH to program into flash memory V2_1 algo or above  */
/*   ADD FLASH SECTIONS AS NEEDED											*/
/****************************************************************************/

MEMORY
{
   PAGE 0 : RESET(R)     : origin = 0x000000, length = 0x2
   PAGE 0 : BOOT(R)		 : origin = 0x3E8000, length = 0x80
   PAGE 0 : FLASHA       : origin = 0x3E8080, length = 0x0FF70     /* on-chip FLASH*/
   PAGE 0 : BOOTJUMP(R)  : origin = 0x03F7FF6, length = 0x2
