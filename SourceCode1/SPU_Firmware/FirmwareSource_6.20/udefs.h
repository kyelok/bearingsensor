...
#define F_MAXVOLUME	1//ajb changed from 5     /* maximum number of volumes */
#define F_MAXTASK   1//ajb changed from 10     /* maximum number of task */

#define F_MAXPATH 20//ajb changed from 256
...
#define F_MAXFILES  1//ajb changed from 10     /* maximum number of files */
